...
public class JoinActivity_A extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_join_a);

        TextView tv = (TextView)findViewById(R.id.join_a_contents);
        String contents = "제 1 조 (목적)\n" +
        ...
        tv.setText(contents);
        Toast.makeText(this,"가입 완료 시 약관 동의로 간주합니다.",Toast.LENGTH_SHORT).show();


    }
    public void join_aggr_Check(View v) {
        switch(v.getId()){
            case R.id.join_a_check:
