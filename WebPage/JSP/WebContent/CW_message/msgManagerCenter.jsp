...
<%
		...
		if((String)request.getParameter("menuOrder")==null){
			list = msgdao.messageListManager(10, loginId);
		}else{
			String menuOrder = (String)request.getParameter("menuOrder");
			list = msgdao.messageListManager(Integer.parseInt(menuOrder), loginId);
		}
					...
					<div class="sidebar">
						...
						<div class="widget widget_categories">
							...
							<ul class="arrows_list list_style">
								<li><a href="/CW/CW_message/msgManager.jsp?menuOrder=0">전체(<%=msgdao.messageCountManager(0, loginId) %>)</a></li>
								<li><a href="/CW/CW_message/msgManager.jsp?menuOrder=1">사용자(<%=msgdao.messageCountManager(1, loginId) %>)</a></li>
								<li><a href="/CW/CW_message/msgManager.jsp?menuOrder=2">공사관리자(<%=msgdao.messageCountManager(2, loginId) %>)</a></li>
							</ul>
						</div>
						...
						<div class="widget widget_categories">
							...
							<ul class="arrows_list list_style">
								<li><a href="/CW/CW_message/msgManager.jsp?menuOrder=20">전체(<%=msgdao.messageCountManager(0, loginId) %>)</a></li>
								<li><a href="/CW/CW_message/msgManager.jsp?menuOrder=21">사용자(<%=msgdao.messageCountManager(1, loginId) %>)</a></li>
								<li><a href="/CW/CW_message/msgManager.jsp?menuOrder=22">공사관리자(<%=msgdao.messageCountManager(2, loginId) %>)</a></li>
							</ul>
						</div>
