				...
				<div class="col-md-3 col-sm-6">
					<div class="serviceBox_2 purple">
						...
						<div class="service-content">
							...
							<p>메세지를 관리할 수 있습니다.</p>
							<div class="read">
								<a href="/CW/CW_message/msgNormal.jsp">Read more</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="widget widget_tab">
						...
						<div class="tab-content clearfix">
							<div class="tab-pane fade active in" id="Popular">
								<p>학교 시설담당 교직원으로부터 받은 <br>최근 메세지를 날짜 내림차순으로 표기합니다.</p>
								<ul class="list_style circle">
									<% list = msgdao.messageListNormal(21, loginId); %>
							...
							<div class="tab-pane fade" id="Recent">
								<p>공사관리자로부터 받은 <br>최근 메세지를 날짜 내림차순으로 표기합니다.</p>
								<ul class="list_style">
									<% list = msgdao.messageListNormal(22, loginId); %>
									<%for(MessageVo msgvo : list){ %>
									<li><a href="#"> <%=msgvo.getMsg_title() %></a></li>
									<%} %>
								</ul>
