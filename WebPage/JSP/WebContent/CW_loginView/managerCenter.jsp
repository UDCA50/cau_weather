				...
				<div class="col-md-3 col-sm-6">
					<div class="serviceBox_2 purple">
						...
						<div class="service-content">
							...
							<p>메세지를 관리할 수 있습니다.</p>
							<div class="read">
								<a href="/CW/CW_message/msgManager.jsp">Read more</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-4 wow fadeInLeft">
					...
					<div class="widget widget_tab">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#Popular" data-toggle="tab">사용자</a></li>
						...
						<div class="tab-content clearfix">
							<div class="tab-pane fade active in" id="Popular">
								<p>사용자로부터 받은 최근 메세지를<br>날짜 내림차순으로 표시합니다.</p>
								<ul class="list_style circle">
								<% list = msgdao.messageListManager(21, loginId); %>
							...
							<div class="tab-pane fade" id="Recent">
								<p>공사관계자로부터 받은 최근 메세지를<br>날짜 내림차순으로 표시합니다.</p>
								<ul class="list_style circle">
								<% list = msgdao.messageListManager(22, loginId); %>
									<%for(MessageVo msgvo : list){ %>
									<li><a href="#">  <%=msgvo.getMsg_title() %></a></li>
									<%} %>
								</ul>
							...
							<div class="tab-pane fade" id="Recent-Comment">
								<p>전체 메세지를<br>날짜 내림차순으로 표기합니다.</p>
								<ul class="list_style circle">
								<% list = msgdao.messageListManager(20, loginId); %>
									<%for(MessageVo msgvo : list){ %>
									<li><a href="#"> <%=msgvo.getMsg_title() %> </a></li>
									<%} %>
								</ul>
